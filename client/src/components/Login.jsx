    ...
    <div className="w-full max-w-md p-8">
      ...
      >
        <div className="space-y-4 text-center">
          ...
          <h1 className="text-4xl font-display uppercase tracking-tight text-white italic">Login</h1>
          <p className="text-muted text-sm font-body max-w-[240px] mx-auto">Sign in to your BringIt account.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full bg-white text-bg-deep font-black py-4 rounded-2xl flex items-center justify-center gap-2 hover:bg-brand-cyan hover:shadow-lg hover:shadow-brand-cyan/20 transition-all shadow-xl shadow-brand-cyan/10 group"
          >
        ...
        <div className="text-center">
          <p className="text-xs text-muted font-medium">
            Don't have an account? <Link to="/register" className="text-brand-cyan hover:underline decoration-cyan-500/30 underline-offset-4">Register</Link>
          </p>
        </div>
      </motion.div>
    </div>
